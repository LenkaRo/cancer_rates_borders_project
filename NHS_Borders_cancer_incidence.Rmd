...
Note: Some of the cancer site categories also include sub-categories, please see the footnote for more detail:^[Non-melanoma skin cancer (incl. Squamous cell carcinoma of the skin, Basal cell carcinoma of the skin); <br>
...
skin_cancer_rates %>%
  ...
  ggplot() +
    ...
    labs(
      x = "",
      y = "rate per 100,000 persons at risk",
